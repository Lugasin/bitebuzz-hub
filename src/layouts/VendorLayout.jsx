...
const VendorLayout = ({ children }) => {
  ...
  const navLinks = [
    ...
    { path: '/vendor/menu', label: 'Menu Management', icon: Utensils },
            ...
            <div className="flex items-center gap-2">
              ...
              <Link to="/vendor/dashboard" className="flex items-center gap-2">
                <img 
                  ...
                  className="h-8 w-8" 
                />
                <span className="font-bold text-lg hidden sm:inline-block">Vendor Portal</span>
              </Link>
            </div>
          ...
          <div className="border-b">
            <div className="container mx-auto px-4">
              <div className="py-2 flex items-center text-sm">
                <Link to="/vendor/dashboard" className="text-muted-foreground hover:text-foreground">
                  Dashboard
                </Link>
